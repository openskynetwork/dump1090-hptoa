...
ifeq ($(UNAME), Linux)
LIBS+=-lrt
CFLAGS+=-std=c11 -D_DEFAULT_SOURCE -Ihp-toa
endif
ifeq ($(UNAME), Darwin)
...
dump1090: dump1090.o anet.o interactive.o mode_ac.o mode_s.o net_io.o crc.o demod_2400.o stats.o cpr.o icao_filter.o track.o util.o convert.o hp-toa/HP-TOA.o $(COMPAT)
...
clean:
	rm -f *.o compat/clock_gettime/*.o compat/clock_nanosleep/*.o hp-toa/*.o dump1090 view1090 faup1090 cprtests crctests
